package com.example.chens.mini2assignment2.UI;
...
import com.example.chens.mini2assignment2.util.DataBase;
import com.example.chens.mini2assignment2.model.Mortgage;
import com.example.chens.mini2assignment2.R;
...
//                    db.close();
                    ...
                    try {
                        ...
                        File log = new File(getFilesDir(), logName);
                        System.out.println("---------");
